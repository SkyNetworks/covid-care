...
const questions = [
  ...
  {
    question: "feeling shortness of breath ?",
    optionA: "yes",
    optionB: "no",
    optionC: "can not say",
    optionD: "leave question",
...
function handleEndGame() {
  ...
  if (playerScore <= 2) {
    remark = "may Be You Are not Covid Positive.";
    remarkColor = "green";
  } else if (playerScore >= 3 && playerScore < 7) {
    remark = "high chance you are corona positive.";
    remarkColor = "orange";
  } else if (playerScore >= 7) {
    remark = " high risk may be you are corona Positive.";
    remarkColor = "red";
  }
